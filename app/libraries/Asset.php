...
class Asset {
	...
	{
		// No alternative text given? Use the filename, better th// No alternative text given? Use the filename, better than nothing!
	...
	private function _other_asset_location($asset_name, $module_name = NULL, $asset_type = NULL, $location_type = 'url')
	{
		...
		else
		{
			...
			if (is_dir('templates/admin_themes/'.ADMIN_THEME))
			{
				$admin_path = 'templates/admin_themes/'.ADMIN_THEME;
			}
			elseif (is_dir('templates/admin_themes/'.ADMIN_THEME))
			{
				$admin_path = 'templates/admin_themes/'.ADMIN_THEME;
			}
