...
if(preg_match('/127\.0\.0\.1/', $_SERVER['REMOTE_ADDR'])){
...
*/
$urls_exempted_from_csrf_protection = array(
	'verify_otp',
	'create_otp','
	create_otp',
	'endpoint',
	...
	'/dbfix',
	'ajax',
	'ipn/mpesa_validation',
	'ipn/mpesa_confirmation',
	'ipn/equity',
	'billing/price_calculator',
	'sms/sms_send_to_options',
	'sms/sms_multiple_segment_options',
	'sms/sms_send_to_group_and_user_lists',
	'sms/sms_all_group_and_user_lists',
	'ara','transaction_alerts/softgen',
	'emails/count_mails',
	'mobile',
	'ussd',
	'action',
	'extend_session',
	'get_loan_repayment_type',
	'loan_calculator',
	'withdrawals/process_withdrawal_request_disbursement',
);

$uri_string = $_SERVER["REQUEST_URI"];
$disable_csrf_protection = FALSE;
foreach ($urls_exempted_from_csrf_protection as $key => $value) {
