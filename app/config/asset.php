...
$config['asset_dir'] =  'templates/admin_themes/admin/';
...
$config['asset_url'] = 'templates/admin_themes/admin/';
...
$config['theme_asset_dir'] =  'templates/admin_themes/';
...
$config['theme_asset_url'] = 'templates/admin_themes/';
